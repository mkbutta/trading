...
[![Build Status](https://travis-ci.org/mkbutta/tmo-products.svg?branch=master)](https://travis-ci.org/mkbutta/tmo-products)
...
6. If you did everything correct, https://mkbutta.github.io/tmo-products/ will lead to your new docs
...
- Documentation(ReDoc): https://mkbutta.github.io/tmo-products/
- SwaggerUI: https://mkbutta.github.io/tmo-products/swagger-ui/
- Look full spec:
    + JSON https://mkbutta.github.io/tmo-products/swagger.json
    + YAML https://mkbutta.github.io/tmo-products/swagger.yaml
- Preview spec version for branch `[branch]`: https://mkbutta.github.io/tmo-products/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mkbutta.github.io/tmo-products/ with url from the message: `Server started <url>`
